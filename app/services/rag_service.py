...
def _build_prompt_messages(question: str, contexts: List[RetrievalHit]):
    system_prompt = (
    ...
    # Convert to OpenAI/Anthropic style payload
...
def answer_question(
    ...
    *,
    ...
    if "claude" in lower_model:
        ...
        answer = _call_openai_chat(model_name, messages)

    return answer, contexts, model_name


def _call_openai_chat(model_name: str, messages: List[dict]) -> str:
